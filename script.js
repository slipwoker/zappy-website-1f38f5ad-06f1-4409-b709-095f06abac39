    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Ezuz משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '1f38f5ad-06f1-4409-b709-095f06abac39',
                    name: data.name || '',
                    email: data.email || '',
...
/* Integration Scripts */
// setup_contact_form_emails functionality
// Email integration configured for Ezuz
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '1f38f5ad-06f1-4409-b709-095f06abac39';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '1f38f5ad-06f1-4409-b709-095f06abac39';
